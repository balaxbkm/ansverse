                ...
                <div className="relative z-20 p-12 md:p-24 flex flex-col md:flex-row items-center justify-between gap-12">
                    <div className="max-w-2xl">
                        ...
                        <div className="flex flex-row items-center gap-4">
                            <button className="h-14 px-6 md:px-8 bg-white text-black rounded-full font-bold text-lg hover:bg-zinc-100 transition-all active:scale-95 flex items-center justify-center gap-2">
                                <Mail className="w-5 h-5" />
                                <span className="md:hidden">Mail</span>
                                <span className="hidden md:inline">hello@ansverse.com</span>
                            </button>
                            <button className="group relative w-14 h-14 flex-shrink-0 bg-[#25D366] text-white rounded-full font-bold text-lg hover:bg-[#20bd5a] transition-all active:scale-95 flex items-center justify-center shadow-[0_0_20px_rgba(37,211,102,0.3)] hover:shadow-[0_0_30px_rgba(37,211,102,0.5)]" aria-label="WhatsApp">
